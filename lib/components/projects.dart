...
import 'package:protfolio/database/dbHelper.dart';
import 'package:protfolio/model/project.dart';

import 'package:protfolio/utilis/addProject.dart';
...
class _ProjectsState extends State<Projects> {
  ...
  fetch() async {
    final data = await DbHelper.getAllProjects();
    setState(() {
      projects = data;
    });
  }
          ...
          Container(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(
                      onPressed: () async {
                        if (await DbHelper.deleteAllProjects()) {
